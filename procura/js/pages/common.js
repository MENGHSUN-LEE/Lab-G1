...
import { renderMaterialsTable } from './detail/materials.js';
...
import { renderVendorManagement } from './detail/vendor_management.js';
...
export function setActiveTab(key) {
  ...
  if (key === "overview") renderMaterialOverview(state.currentProject);
  if (key === "vendor") renderVendorManagement(state.currentProject);
